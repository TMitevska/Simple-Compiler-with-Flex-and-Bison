...
/*****************************Declarators********************/            
VarDec      :   ID		      {$$ = $1;}               
            |   VarDec LB INT RB	{$$=CreatNonTreeNode("arrary"); AddNode($$,$1,$3, NULL);}	   
...
ParamDec    :   Specifier VarDec	{$$=$1; AddSibling($1, $2, NULL);}	
            ...
            ;
/*****************************Statements********************/       
CompSt      :   LC DefList StmtList RC	{$$=CreatNonTreeNode("FucBody"); AddNode($$,CreatNonTreeNode("NewScope"), $2,$3,CreatNonTreeNode("EndScope"),NULL);} 	
            ;
...
Exp         :   Exp ASSIGNOP Exp	{$$=CreatNonTreeNode("Exp");AddNode($$,$2,NULL); AddNode($2, $1, $3, NULL);}   	    
            ...
            |   Exp DOT ID	{$$ = $1; if($1->child) AddSibling($1->child, $2, $3, NULL); else AddSibling($1, $2, $3, NULL);}	           
